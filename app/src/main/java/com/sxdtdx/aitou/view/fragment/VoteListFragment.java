...
public class VoteListFragment extends Fragment implements IVoteList{
    ...
    private View mView;
    private List<PublicVote> mPublicVotes = new ArrayList<>();
    ...
    public void initView() {
        ...
        mVoteListAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                turnToDetailsPage(mPublicVotes.get(position).getObjectId());
            }
        });
    }
    ...
    @Override
    public void refreshLis(List<PublicVote> votes) {
        mPublicVotes = votes;
    ...
    private class VoteListAdapter extends RecyclerView.Adapter<VoteListAdapter.MyHolder> {
        ...
        public void onBindViewHolder(final MyHolder holder, final int position) {
            ...
            PublicVote vote = mPublicVotes.get(position);
